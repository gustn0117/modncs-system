      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2.5 text-sm">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span>박부장: <a href="tel:010-6603-3432" className="text-gold-400 hover:text-gold-300">010-6603-3432</a></span>
              </div>
              <div className="flex items-center gap-2.5">
                <svg className="w-4 h-4 text-gold-400 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                </svg>
                <span>매장: <a href="tel:044-868-4874" className="text-gold-400 hover:text-gold-300">044-868-4874</a></span>
              </div>
            </div>
            <div className="mt-5 flex items-center gap-2">
              <span className="text-gold-400 text-xs px-3 py-1 rounded-full font-medium border border-gold-400/30">여성기업인증</span>
              <span className="text-gold-400 text-xs px-3 py-1 rounded-full font-medium border border-gold-400/30">캐논코리아 공식 인증</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-navy-900 rounded-xl border border-navy-800">
              <p className="text-xs text-gray-500 mb-1">상담 가능 시간</p>
              <p className="text-white font-semibold">평일 09:00 ~ 18:00</p>
              <p className="text-xs text-gray-500 mt-1">토/일/공휴일 휴무</p>
            </div>
          </div>
        </div>

        <div className="border-t border-navy-800 mt-12 pt-8 text-center text-sm text-gray-600">

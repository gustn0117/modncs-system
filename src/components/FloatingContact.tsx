...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {isOpen && (
        <div className="bg-white rounded-2xl shadow-2xl p-5 mb-2 w-72 border animate-fadeIn">
          <h3 className="font-bold text-gray-900 mb-3 text-lg">빠른 연락</h3>
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900 text-sm">박부장</p>
                <p className="text-blue-700 font-bold">010-6603-3432</p>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900 text-sm">매장 전화</p>
                <p className="text-green-700 font-bold">044-868-4874</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <button
        ...
        className={`w-16 h-16 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 ${
          isOpen ? 'bg-gray-700 rotate-45' : 'bg-blue-700 animate-bounce'
        }`}
        aria-label="연락처"
      >
        {isOpen ? (
